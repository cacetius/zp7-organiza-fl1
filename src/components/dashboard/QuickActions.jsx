...
const actions = [
  ...
  { label: "Controle de Perdas", icon: TrendingDown, path: "/controle-perdas", color: "bg-rose-500/10 text-rose-400 hover:bg-rose-500/20" },
  ...
  { label: "Checklist", icon: CheckSquare, path: "/checklist", color: "bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20" },
